...
export const typeIcons = {
  ...
  fairy: fairyIcon, fighting: fightingIcon, fire: fireIcon, flying: flyingIcon,
  ghost: ghostIcon, grass: grassIcon, ground: groundIcon, ice: iceIcon,
  normal: normalIcon, poison: poisonIcon, psychic: psychicIcon, rock: rockIcon,
  steel: steelIcon, water: waterIcon,
};

export const typeColors = {
  normal:   { strong: '#A8A77A', light: '#DCDCDC' },
  fire:     { strong: '#EE8130', light: '#FFB971' },
  water:    { strong: '#6390F0', light: '#8CC4E2' },
  electric: { strong: '#F7D02C', light: '#FFE662' },
  grass:    { strong: '#7AC74C', light: '#A8FF98' },
  ice:      { strong: '#96D9D6', light: '#8CF5E4' },
  ...
  ghost:    { strong: '#735797', light: '#8291E0' },
  dragon:   { strong: '#6F35FC', light: '#88A2E8' },
  dark:     { strong: '#705746', light: '#8E8C94' },
  steel:    { strong: '#B7B7CE', light: '#9FB8B9' },
  fairy:    { strong: '#D685AD', light: '#FDB9E9' },
  default:  { strong: '#A8A77A', light: '#DCDCDC' },
};